...
const Bestellung = ({ lieferung, produkte, status, id }) => {
	...
	return (
			<div className="Bestellung">
				...
				<p className="grey small">{produkte.length} Produkte</p>
				<div className="Bestellung__details">
					...
					<p className="status grey">Status</p><p className={lieferung.statusNummer === 0 ? "status info" : lieferung.statusNummer === 1 ? "status info green" : "status info"}>{status[status.length - 1].statusKurz}</p>
				</div>
